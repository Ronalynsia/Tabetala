...
<main class="flex-1 p-6">
  ...
  <div class="bg-white rounded-lg shadow p-6 text-center">
    ...
    <!-- Profile Tabs -->
    <div class="border-b my-6 flex justify-center space-x-10">
    ...
    <div id="user-info" class="tab-pane">
      <form action="update_profile.php" method="POST" class="space-y-4 text-left">
    ...
    <div id="change-avatar" class="tab-pane hidden">
      <form action="update_avatar.php" method="POST" enctype="multipart/form-data" class="space-y-4 text-left">
        <div>
